...
* Large number of collections for many tenants
* Requires naming and cleanup discipline

**Alternative Improvement:**

* Single DB with `org_id` field (logical tenancy)
* Hybrid approach for very large scale systems
